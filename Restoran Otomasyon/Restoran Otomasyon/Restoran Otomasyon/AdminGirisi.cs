        ...
        private void GirisButon_Click(object sender, EventArgs e)
        {
            ...
            if (TCTextBox.Text != "" && SifreTextBox.Text != "")
            {
                try
                {
                    ...
                    baglanti.Open();
                    string sql = "select * from yönetici where tc=@kadi and sifre=@sifre";
            ...
            {
                MessageBox.Show("Lütfen boş giriş yapmayınız !!!", "Bir hata gerçekleşti", MessageBoxButtons.OK, MessageBoxIcon.Warning);
